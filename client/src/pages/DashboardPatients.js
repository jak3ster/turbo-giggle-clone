...
const DashboardPatients = (props) => {
    ...
    if (d === undefined || d === null) {
        doctorFirstName = d.getPatientEmailByID.primarycareteam[0].firstName;
        doctorLastName = d.getPatientEmailByID.primarycareteam[0].lastName;
        concern = d.getPatientEmailByID.appointments[0].concern;
        status = d.getPatientEmailByID.appointments[0].status;
